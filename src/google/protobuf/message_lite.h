...
class PROTOBUF_EXPORT MessageLite {
 public:
  ...
  // Merge a protocol buffer contained in a Cord.
  ...
  PROTOBUF_DEPRECATE_AND_INLINE() bool MergeFromCord(const absl::Cord& cord) {
    return MergeFromString(cord);
  }
  ...
  bool ParsePartialFromCord(const absl::Cord& cord) {
    return ParsePartialFromString(cord);
  }
